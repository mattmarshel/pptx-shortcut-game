...
const VISUALS = {
    "Word Wrap": () => `<div class="vis">${visTitleBar('Formatting')}
        <div class="vis-canvas">
            <div style="position:absolute;left:15px;top:12px;width:90px;height:55px;border:1.5px solid #C5E1A5;border-radius:3px;background:#FAFFF5"></div>
            ...
            <div style="position:absolute;right:15px;top:16px;font-size:6px;color:#217346;font-weight:700">Ctrl+7</div>
            <div style="position:absolute;left:130px;top:50px;font-size:18px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#8629;</div>
        ...
        <div class="vis-canvas">
            <div style="position:absolute;left:50%;top:45%;transform:translate(-50%,-50%);text-align:center">
                <div style="display:flex;gap:4px;margin-bottom:6px;justify-content:center">
                    <div style="width:22px;height:18px;background:#E8F5E9;border:1.5px solid #A5D6A7;border-radius:3px;font-size:6px;display:flex;align-items:center;justify-content:center;font-weight:700;color:#217346;animation:insertAppear 4s ease-in-out infinite">Q</div>
                    <div style="width:22px;height:18px;background:#E8F5E9;border:1.5px solid #A5D6A7;border-radius:3px;font-size:6px;display:flex;align-items:center;justify-content:center;font-weight:700;color:#217346;animation:insertAppear 4s ease-in-out infinite .2s">K</div>
                    <div style="width:22px;height:18px;background:#E8F5E9;border:1.5px solid #A5D6A7;border-radius:3px;font-size:6px;display:flex;align-items:center;justify-content:center;font-weight:700;color:#217346;animation:insertAppear 4s ease-in-out infinite .4s">E</div>
                </div>
                <div style="font-size:6px;color:#586848">Show all shortcut overlays</div>
            </div>
    ...
    "Toggle Shape State": () => `<div class="vis">${visTitleBar('Shapes')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;left:50%;top:48px;transform:translateX(-50%);font-size:14px;color:#217346">&#8644;</div>
            <span class="vis-label">TOGGLE STATE</span>
        </div></div>`,

    "Make Same Size": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:20px;top:15px;width:30px;height:20px;background:#4CAF50;border-radius:3px;animation:sameSize 4s ease-in-out infinite;--from-w:30px;--from-h:20px"></div>
            ...
            <div style="position:absolute;right:30px;top:50%;transform:translateY(-50%);font-size:8px;color:#217346;font-weight:700;animation:visPulse 4s ease-in-out infinite">= SIZE</div>
            <span class="vis-label">SAME SIZE</span>
        </div></div>`,

    "Make Same Height": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:25px;top:20px;width:40px;height:24px;background:#4CAF50;border-radius:3px;animation:sameHeight 4s ease-in-out infinite;--from-h:24px"></div>
            ...
            <div style="position:absolute;right:25px;top:50%;transform:translateY(-50%);font-size:8px;color:#217346;font-weight:700;animation:visPulse 4s ease-in-out infinite">= H</div>
    ...
    "Make Same Width": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:20px;top:15px;width:25px;height:35px;background:#4CAF50;border-radius:3px;animation:sameWidth 4s ease-in-out infinite;--from-w:25px"></div>
            ...
            <div style="position:absolute;right:25px;top:50%;transform:translateY(-50%);font-size:8px;color:#217346;font-weight:700;animation:visPulse 4s ease-in-out infinite">= W</div>
            <span class="vis-label">SAME WIDTH</span>
        </div></div>`,

    "Insert Textbox": () => `<div class="vis">${visTitleBar('Insert')}
        <div class="vis-canvas">
            <div style="position:absolute;left:50%;top:45%;transform:translate(-50%,-50%);width:120px;height:40px;border:2px solid #217346;border-radius:4px;background:white;animation:insertAppear 4s ease-in-out infinite;display:flex;align-items:center;padding-left:8px">
                <div style="width:1px;height:18px;background:#217346;animation:visPulse 1s ease infinite"></div>
    ...
    "Text to Autoshape": () => `<div class="vis">${visTitleBar('Shapes')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;left:50%;top:48px;transform:translateX(-50%);font-size:12px;color:#217346">&#10140;</div>
            <div style="position:absolute;left:20px;top:58px;width:80px;height:40px;border:2px solid #4CAF50;border-radius:20px;background:#E8F5E9;font-size:7px;display:flex;align-items:center;justify-content:center;color:#217346;animation:insertAppear 4s ease-in-out infinite">AutoShape</div>
            <span class="vis-label">CONVERT</span>
        </div></div>`,

    "Align and Group": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:15px;top:12px;width:30px;height:25px;background:#4CAF50;border-radius:3px;animation:alignL 4s ease-in-out infinite;--from-x:15px"></div>
            ...
            <div style="position:absolute;left:8px;top:8px;width:70px;height:95px;border:2px dashed #217346;border-radius:4px;animation:groupShow 4s ease-in-out infinite"></div>
            <span class="vis-label">ALIGN + GROUP</span>
        </div></div>`,

    "Copy Position": () => `<div class="vis">${visTitleBar('Position')}
        <div class="vis-canvas">
            <div style="position:absolute;left:30px;top:25px;width:45px;height:35px;background:#4CAF50;border-radius:3px;display:flex;align-items:center;justify-content:center">
                <span style="font-size:6px;color:white;font-weight:700">SOURCE</span>
            </div>
            <div style="position:absolute;left:30px;top:25px;width:45px;height:35px;border:2px dashed #217346;border-radius:3px;animation:visPulse 2s ease-in-out infinite"></div>
            <div style="position:absolute;left:35px;top:68px;font-size:6px;color:#217346;font-weight:600">x:30 y:25</div>
            <div style="position:absolute;right:30px;top:30px;font-size:14px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#128203;</div>
    ...
    "Paste Position": () => `<div class="vis">${visTitleBar('Position')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;left:50%;bottom:8px;transform:translateX(-50%);font-size:6px;color:#586848">Pastes to copied position</div>
            <span class="vis-label">PASTE POS</span>
        </div></div>`,

    "Normal View": () => `<div class="vis">${visTitleBar('View')}
        <div class="vis-canvas">
            <div style="position:absolute;left:8px;top:6px;width:40px;height:90px;background:#E8F5E9;border:1px solid #C5E1A5;border-radius:2px;padding:3px">
            ...
            <div style="position:absolute;left:55px;top:6px;width:100px;height:75px;background:white;border:2px solid #217346;border-radius:3px;display:flex;align-items:center;justify-content:center;animation:insertAppear 4s ease-in-out infinite">
                <div style="text-align:center"><div style="font-size:8px;font-weight:700;color:#217346">Slide</div><div style="font-size:6px;color:#888">Normal View</div></div>
            </div>
    ...
    "Slide Sorter View": () => `<div class="vis">${visTitleBar('View')}
        <div class="vis-canvas" style="display:flex;flex-wrap:wrap;gap:5px;padding:8px;align-content:flex-start">
            ${[1,2,3,4,5,6].map((n,i) => `<div style="width:42px;height:30px;background:white;border:1.5px solid ${i===0?'#217346':'#ddd'};border-radius:2px;font-size:6px;display:flex;align-items:center;justify-content:center;color:#888;animation:insertAppear 4s ease-in-out infinite ${i*0.15}s">Slide ${n}</div>`).join('')}
    ...
    "Fit to Window": () => `<div class="vis">${visTitleBar('View')}
        <div class="vis-canvas" style="display:flex;align-items:center;justify-content:center">
            <div style="width:80%;height:80%;background:white;border:2px solid #217346;border-radius:3px;display:flex;align-items:center;justify-content:center;animation:zoomFit 4s ease-in-out infinite">
                <div style="text-align:center"><div style="font-size:9px;font-weight:700;color:#217346">&#x2922;</div><div style="font-size:6px;color:#888">Fit to Window</div></div>
            </div>
    ...
    "Insert Sticker": () => `<div class="vis">${visTitleBar('Insert')}
        <div class="vis-canvas" style="display:flex;align-items:center;justify-content:center">
            <div style="animation:insertAppear 4s ease-in-out infinite;text-align:center">
                <div style="width:50px;height:50px;background:#E8F5E9;border:2px solid #4CAF50;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:22px">&#9733;</div>
    ...
    "Insert Legend": () => `<div class="vis">${visTitleBar('Insert')}
        <div class="vis-canvas">
            <div style="position:absolute;right:15px;top:10px;width:80px;background:white;border:1.5px solid #C5E1A5;border-radius:4px;padding:5px;animation:insertAppear 4s ease-in-out infinite">
                <div style="font-size:6px;font-weight:700;color:#333;margin-bottom:4px">Legend</div>
                <div style="display:flex;align-items:center;gap:4px;margin-bottom:2px"><div style="width:10px;height:6px;background:#4CAF50;border-radius:1px"></div><span style="font-size:5px;color:#666">Series A</span></div>
            ...
            <div style="position:absolute;left:12px;top:15px;width:50px;height:65px;background:#f5f5f5;border:1px solid #ddd;border-radius:3px;display:flex;align-items:flex-end;padding:4px;gap:3px">
                <div style="width:10px;background:#4CAF50;height:60%;border-radius:2px 2px 0 0"></div>
    ...
    "Reset Fixed Elements": () => `<div class="vis">${visTitleBar('Tools')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;left:50%;top:80px;transform:translateX(-50%);font-size:14px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#8634;</div>
    ...
    "Split/Join Textboxes": () => `<div class="vis">${visTitleBar('Tools')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;left:15px;top:26px;width:110px;height:22px;background:white;border:1.5px solid #217346;border-radius:3px;font-size:6px;display:flex;align-items:center;padding:0 6px;color:#333">Hello World! How are you?</div>
            <div style="position:absolute;left:50%;top:52px;transform:translateX(-50%);font-size:10px;color:#217346">&#8595;</div>
            <div style="position:absolute;left:15px;top:60px;font-size:6px;color:#888;font-weight:600">AFTER:</div>
            <div style="position:absolute;left:15px;top:72px;width:52px;height:22px;background:white;border:1.5px solid #4CAF50;border-radius:3px;font-size:6px;display:flex;align-items:center;padding:0 6px;color:#333;animation:insertAppear 4s ease-in-out infinite">Hello World!</div>
            <div style="position:absolute;left:75px;top:72px;width:52px;height:22px;background:white;border:1.5px solid #4CAF50;border-radius:3px;font-size:6px;display:flex;align-items:center;padding:0 6px;color:#333;animation:insertAppear 4s ease-in-out infinite .2s">How are you?</div>
    ...
    "Distribute Vertically": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:40px;top:5px;width:45px;height:18px;background:#4CAF50;border-radius:3px;animation:distributeV 4s ease-in-out infinite;--from-y:5px;--to-y:8px"></div>
            ...
            <div style="position:absolute;right:20px;top:50%;transform:translateY(-50%) rotate(90deg);font-size:16px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#8651;</div>
            <span class="vis-label">DISTRIBUTE V</span>
        </div></div>`,

    "Distribute Horizontally": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:5px;top:30px;width:25px;height:35px;background:#4CAF50;border-radius:3px;animation:distributeH 4s ease-in-out infinite;--from-x:5px;--to-x:15px"></div>
            ...
            <div style="position:absolute;left:50%;bottom:8px;transform:translateX(-50%);font-size:16px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#8651;</div>
    ...
    "Paste Unformatted Text": () => `<div class="vis">${visTitleBar('Formatting')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;left:50%;top:46px;transform:translateX(-50%);font-size:10px;color:#217346">&#8595;</div>
    ...
    "Shape to Text Box": () => `<div class="vis">${visTitleBar('Shapes')}
        <div class="vis-canvas">
            <div style="position:absolute;left:20px;top:18px;width:55px;height:55px;background:#E8F5E9;border:2px solid #4CAF50;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:7px;color:#217346">Shape</div>
            <div style="position:absolute;left:50%;top:42px;transform:translateX(-50%);font-size:14px;color:#217346">&#10140;</div>
    ...
    "Apply Default Text Format": () => `<div class="vis">${visTitleBar('Formatting')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;right:15px;top:60px;font-size:14px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#8998;</div>
    ...
    "Insert New Slide": () => `<div class="vis">${visTitleBar('Insert')}
        <div class="vis-canvas">
            ...
            <div style="position:absolute;left:80px;top:10px;width:55px;height:40px;background:white;border:2px solid #217346;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:6px;color:#217346;font-weight:700;animation:insertAppear 4s ease-in-out infinite">+ New</div>
    ...
    "Change Font Size": () => `<div class="vis">${visTitleBar('Formatting')}
        <div class="vis-canvas" style="display:flex;align-items:center;justify-content:center">
            <div style="animation:fontGrow 4s ease-in-out infinite;color:#217346;font-weight:700;font-family:Inter,sans-serif">Aa</div>
            <span class="vis-label">FONT SIZE</span>
        </div></div>`,

    "Group": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:20px;top:15px;width:35px;height:28px;background:#4CAF50;border-radius:3px"></div>
            ...
            <div style="position:absolute;left:14px;top:10px;width:68px;height:74px;border:2px dashed #217346;border-radius:4px;animation:groupShow 4s ease-in-out infinite"></div>
            <div style="position:absolute;right:20px;top:50%;transform:translateY(-50%);text-align:center">
                <div style="font-size:20px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#9744;</div>
    ...
    "Ungroup": () => `<div class="vis">${visTitleBar('Alignment')}
        <div class="vis-canvas">
            <div style="position:absolute;left:20px;top:15px;width:35px;height:28px;background:#4CAF50;border-radius:3px;animation:ungroupScatter 4s ease-in-out infinite;--from-x:20px;--from-y:15px;--to-x:8px;--to-y:5px"></div>
            ...
            <div style="position:absolute;left:14px;top:10px;width:68px;height:74px;border:2px dashed #217346;border-radius:4px;animation:ungroupHide 4s ease-in-out infinite"></div>
    ...
    "Pickup Style": () => `<div class="vis">${visTitleBar('Formatting')}
        <div class="vis-canvas">
            <div style="position:absolute;left:20px;top:20px;width:55px;height:40px;background:#4CAF50;border:2px solid #2E7D32;border-radius:4px;display:flex;align-items:center;justify-content:center;animation:stylePickup 4s ease-in-out infinite">
    ...
    "Apply Style": () => `<div class="vis">${visTitleBar('Formatting')}
        <div class="vis-canvas">
            <div style="position:absolute;left:20px;top:25px;width:45px;height:35px;background:#4CAF50;border:2px solid #2E7D32;border-radius:4px;font-size:6px;color:white;display:flex;align-items:center;justify-content:center;font-weight:700">Source</div>
            <div style="position:absolute;left:50%;top:38px;transform:translateX(-50%);font-size:12px;color:#217346">&#10140;</div>
    ...
    "Insert Footnote": () => `<div class="vis">${visTitleBar('Insert')}
        <div class="vis-canvas">
            <div style="position:absolute;left:15px;top:8px;width:120px;height:55px;background:white;border:1px solid #ddd;border-radius:3px;padding:6px">
                <div style="font-size:6px;color:#333;line-height:1.5">Presentation content goes here<br>with important details<sup style="color:#217346;font-weight:700">1</sup></div>
            </div>
            <div style="position:absolute;left:15px;top:68px;width:120px;border-top:1px solid #ccc;padding-top:4px;animation:insertAppear 4s ease-in-out infinite">
                <div style="font-size:5px;color:#666"><sup style="color:#217346;font-weight:700">1</sup> This is the footnote text</div>
            </div>
    ...
    "Increase List Level": () => `<div class="vis">${visTitleBar('Lists')}
        <div class="vis-canvas" style="padding:10px 15px">
            ...
            <div style="font-size:6.5px;color:#217346;font-weight:600;animation:indentRight 4s ease-in-out infinite">&#8226; Second item</div>
            <div style="font-size:6.5px;color:#333;margin-bottom:4px">&#8226; Third item</div>
            <div style="position:absolute;right:15px;top:50%;transform:translateY(-50%);font-size:16px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#8618;</div>
    ...
    "Decrease List Level": () => `<div class="vis">${visTitleBar('Lists')}
        <div class="vis-canvas" style="padding:10px 15px">
            <div style="font-size:6.5px;color:#333;margin-bottom:4px">&#8226; First item</div>
            <div style="font-size:6.5px;color:#217346;font-weight:600;animation:indentLeft 4s ease-in-out infinite">&#8226; Second item</div>
            <div style="font-size:6.5px;color:#333;margin-bottom:4px">&#8226; Third item</div>
            <div style="position:absolute;right:15px;top:50%;transform:translateY(-50%);font-size:16px;color:#217346;animation:visPulse 4s ease-in-out infinite">&#8617;</div>
            <span class="vis-label">INDENT -</span>
        </div></div>`,
...
function makeAlignVisual(direction) {
    ...
    return `<div class="vis">${tb}<div class="vis-canvas">
        ...
        <div style="position:absolute;right:15px;top:50%;transform:translateY(-50%);font-size:16px;color:#217346;animation:visPulse 4s ease-in-out infinite">${arrow}</div>
...
function makePrintVisual(slidesPerPage) {
    ...
    let slides = '';
    if (slidesPerPage === 1) {
        slides = `<div style="width:70px;height:50px;background:white;border:1.5px solid #217346;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:7px;color:#217346">Slide 1</div>`;
    } else if (slidesPerPage === 2) {
        slides = `<div style="display:flex;flex-direction:column;gap:4px">
            <div style="width:65px;height:24px;background:white;border:1px solid #217346;border-radius:2px;font-size:6px;display:flex;align-items:center;justify-content:center;color:#217346">Slide 1</div>
            <div style="width:65px;height:24px;background:white;border:1px solid #217346;border-radius:2px;font-size:6px;display:flex;align-items:center;justify-content:center;color:#217346">Slide 2</div>
        </div>`;
    } else {
        slides = `<div style="display:grid;grid-template-columns:1fr 1fr;gap:3px">
            ${[1,2,3,4].map(n => `<div style="width:32px;height:22px;background:white;border:1px solid #217346;border-radius:1px;font-size:5px;display:flex;align-items:center;justify-content:center;color:#217346">${n}</div>`).join('')}
        </div>`;
    }
    return `<div class="vis">${tb}<div class="vis-canvas" style="display:flex;align-items:center;justify-content:center;gap:12px">
        ...
        <div style="text-align:center">
            <div style="font-size:20px;color:#217346">&#128424;</div>
...
function makeOrderVisual(direction) {
    ...
    const highlightColor = isFront ? '#4CAF50' : '#EF5350';
    ...
    return `<div class="vis">${tb}<div class="vis-canvas">
        ...
        <div style="position:absolute;left:65px;top:38px;width:50px;height:40px;background:${highlightColor};border:2px solid ${isFront ? '#2E7D32' : '#C62828'};border-radius:3px;animation:${animName} 4s ease-in-out infinite;display:flex;align-items:center;justify-content:center">
            <span style="font-size:7px;color:white;font-weight:700">&#9733;</span>
        </div>
        <div style="position:absolute;right:15px;top:20px;font-size:${isFront ? '18' : '16'}px;color:${isFront ? '#217346' : '#C62828'};animation:visPulse 4s ease-in-out infinite">${isFront ? '&#8593;' : '&#8595;'}</div>
...
function addSVGDefs() {
    ...
    if (svg) {
        ...
        stop2.setAttribute('offset', '100%'); stop2.setAttribute('stop-color', '#66BB6A');
